        ...
        <div class="container d-flex justify-content-between align-items-center">
            <a class="navbar-brand h1" href="index.html">
               <!-- <i class='bx bx-buildings bx-sm text-dark'></i>
                ...
                <div id='logo'><img class="logo-img" src="assets/img/Mivizy Logo png_small.png"></div>
            </a>
                        ...
                        <tr>
                            <td>
                                <select class="user-type">
                                    <option vlue="user">User</option>
                                    <option vlue="partner">Partner</option>
                                    <option vlue="dietitian">Dietitian</option>
                                </select>
                            </td>
                            <td>
                                <button class="btn btn-info btn-sm user-login">Login</button>
                            </td>
                        </tr>
                    </table>
                        ...
                        <div class="py-5 row d-flex align-items-center" >
                            ...
                            <div class="banner-content col-9 col-lg-9 col-md-10 col-sm-12 offset-2 m-lg-auto text-left py-5 pb-5">
                                ...
                                <p class="banner-body py-3 mx-0 px-0">
                                    Advancing Treatment | Advancing Life <i class='bx bx-chevron-right'></i>
                                    Enrich your life and Other's
